...
const guides = [
  ...
  },
  {
    ...
    stats: [
      ["LFP", "Daily-charge friendly", "🔋"],
      ["NCA", "Range / performance bias", "🚀"],
      ["Best fit", "Usage-profile dependent", "👤"],
      ["Main question", "Charging routine", "🔌"],
    ],
    checklistEn: [
...

  {
    slug: "tesla-model-3-buying-guide",
    category: "Comparison",
    titleEn: "Model 3 vs Model Y buyer lens",
    titleBg: "Model 3 срещу Model Y през погледа на купувача",
    textEn: "Fast decision lens for efficiency, space, daily use and long-term fit.",
    textBg: "Бърза рамка за избор според ефективност, пространство, ежедневна употреба и дългосрочен fit.",
    stats: [
      ["Model 3", "Efficiency-first", "📉"],
      ["Model Y", "Space-first", "📦"],
      ["Best for", "Use-case fit", "✅"],
      ["Main trade-off", "Weight vs practicality", "⚖️"],
    ],
    checklistEn: [
      ["Daily route", "Urban / motorway split", "🛣"],
      ["Cargo needs", "Family and luggage reality", "📦"],
      ["Tyres", "Wear and replacement budget", "🛞"],
      ["Energy use", "Real consumption matters", "🔋"],
    ],
    checklistBg: [
      ["Ежедневен маршрут", "Градско / магистрално ползване", "🛣"],
      ["Багажни нужди", "Реална семейна употреба", "📦"],
      ["Гуми", "Износване и бюджет за смяна", "🛞"],
      ["Разход", "Реалната консумация има значение", "🔋"],
    ],
  },
  {
    slug: "tesla-charging-guide-europe",
    category: "Charging",
    titleEn: "AC vs DC charging snapshot",
    titleBg: "AC срещу DC зареждане накратко",
    textEn: "Decision snapshot for daily charging, travel charging and battery routine.",
    textBg: "Кратка рамка за избор между ежедневно зареждане, пътуване и батерийна рутина.",
    stats: [
      ["AC", "Home / overnight base", "🏠"],
      ["DC", "Travel speed tool", "⚡"],
      ["Best routine", "Mostly AC, selective DC", "🔌"],
      ["Main risk", "Convenience overuse", "⚠️"],
    ],
    checklistEn: [
      ["Home setup", "Prefer stable overnight charging", "🏠"],
      ["Fast charge use", "Use strategically for trips", "⚡"],
      ["Battery fit", "Match routine to chemistry", "🔋"],
      ["Cost", "Compare total energy pattern", "€"],
    ],
    checklistBg: [
      ["Домашна база", "Предпочитай стабилно нощно зареждане", "🏠"],
      ["Бързо зареждане", "Използвай стратегически при път", "⚡"],
      ["Батерия", "Съобрази рутината с химията", "🔋"],
      ["Разход", "Сравнявай общия енергиен модел", "€"],
    ],
  },
  {
